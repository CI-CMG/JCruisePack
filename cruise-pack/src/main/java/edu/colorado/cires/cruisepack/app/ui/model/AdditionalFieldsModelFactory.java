...
public class AdditionalFieldsModelFactory {
  ...
  public static WaterColumnAdditionalFieldsModel waterColumn(Map<String, Object> otherFields, List<DropDownItem> items, DropDownItem defaultItem) {
    ...
    setValueIfExists(
        ...
        otherFields,
        String.class,
        (v) -> items.stream().filter(dd -> dd.getValue().equals(v)).findFirst().orElse(defaultItem),
  ...
  public static NavigationAdditionalFieldsModel navigation(Map<String, Object> otherFields, List<DropDownItem> items, DropDownItem defaultItem) {
  ...
  public static SinglebeamAdditionalFieldsModel singlebeam(Map<String, Object> otherFields, List<DropDownItem> items, DropDownItem defaultItem) {
  ...
  public static MagneticsAdditionalFieldsModel magnetics(Map<String, Object> otherFields, List<DropDownItem> items, DropDownItem defaultItem) {
  ...
  public static GravityAdditionalFieldsModel gravity(Map<String, Object> otherFields, List<DropDownItem> items, DropDownItem defaultItem) {

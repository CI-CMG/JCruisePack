...
public class EditPersonDialog extends JComponent {
    ...
    private void init(BeanFactory beanFactory, PeopleList peopleList) {
        ...
        formPanel.add(new JComboBox<>(peopleList.getPeopleList()), configureLayout(0, 0, c -> c.gridwidth = GridBagConstraints.REMAINDER));
        ...
        positionOrgPanel.add(new JTextField(), configureLayout(0, 1, c -> {
            c.weightx = 50;
        }));
        positionOrgPanel.add(new JLabel("Organization"), configureLayout(1, 0, c -> {
            c.weightx = 50;
        }));
        positionOrgPanel.add(new JTextField(), configureLayout(1, 1, c -> {
            c.weightx = 50;
        }));

        formPanel.add(positionOrgPanel, configureLayout(0, 2, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(streetPanel, configureLayout(0, 3, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(cityStatePanel, configureLayout(0, 4, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(postalCountryPhonePanel, configureLayout(0, 5, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(emailOrcidIDPanel, configureLayout(0, 6, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(uuidPanel, configureLayout(0, 7, c -> {
            c.weighty = 100;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));
        ...
        formPanel.add(footerPannel, configureLayout(0, 8, c -> {
            c.weighty = 0;
            c.gridwidth = GridBagConstraints.REMAINDER;
        }));

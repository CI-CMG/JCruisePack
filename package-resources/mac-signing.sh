...
jar -xf ./jars/BOOT-INF/lib/darklaf-macos-3.0.2.jar com/github/weisj/darklaf/platform/darklaf-macos/libdarklaf-macos-x86-64.dylib
...
jar -xf ./jars/BOOT-INF/lib/sqlite-jdbc-3.45.1.0.jar org/sqlite/native/Mac/x86_64/libsqlitejdbc.dylib
...
jar -uf ./jars/BOOT-INF/lib/sqlite-jdbc-3.45.1.0.jar org/sqlite/native/Mac/x86_64/libsqlitejdbc.dylib
...
jar -uf ./jars/BOOT-INF/lib/darklaf-macos-3.0.2.jar com/github/weisj/darklaf/platform/darklaf-macos/libdarklaf-macos-x86-64.dylib

...
public class InstrumentXmlTest {
  ...
  public void testRead() throws Exception {
    ...
    assertEquals(13, instrumentData.getInstrumentGroups().size());
    InstrumentGroup mb = instrumentData.getInstrumentGroups().stream().filter((ig) -> ig.getShortType().equals("MB-BATHY")).findFirst().get();
